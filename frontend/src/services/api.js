...
export const facturasAPI = {
  ...
  pdf:           (id)          => `${API.defaults.baseURL}/facturas/${id}/pdf/?token=${localStorage.getItem('access')}`,
}
...
export const cotizacionesAPI = {
  ...
  pdf:           (id)            => `${API.defaults.baseURL}/cotizaciones/${id}/pdf/?token=${localStorage.getItem('access')}`,
}
